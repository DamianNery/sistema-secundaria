...
const { getCursos, getCurso, 
    postCurso, updateCurso, deleteCurso, getEstudiantesEnCurso, addEstudianteToCurso, addMateriaToCurso } = require('../controllers/cursos'); //Cargar controladores
...
router.post('/:id/estudiantes', addEstudianteToCurso); // Ruta para agregar un estudiante a un curso
